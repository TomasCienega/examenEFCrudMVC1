using examenEFCrudMVC1.Context;
using examenEFCrudMVC1.Models;
using examenEFCrudMVC1.ViewModel;
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;

namespace examenEFCrudMVC1.Controllers
{
    public class EmpleadoController : Controller
    {
        private readonly examenEFCrudMVC1Context _context;
        public EmpleadoController(examenEFCrudMVC1Context context)
        {
            _context = context;
        }
